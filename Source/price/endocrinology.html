...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Эндокринология. Запишитесь на приём в поликлинику по телефону 7 (347) 278-85-35">
    <title>Эндокринология - запись на приём в хозрасчетной поликлинике</title>
    ...
    <main class="page">
      <div class="container">
        <div class="wrapper-title wrapper-title--doctors">
          <h1 class="page__title">Эндокринология</h1>
        </div>
        <ul class="product__menu-list">
          ...
          <li class="product__menu-item product__menu-item--active"><a href="#">Эндокринология</a></li>
        ...
        <p class="directions__desc directions__desc--menu">
          Эндокринолог — это врач, который занимается диагностикой, лечением и профилактикой заболеваний эндокринной системы, регулирующей деятельность практически всех систем и внутренних органов человека.
        </p>
        <p class="directions__desc directions__desc--menu">
          Записаться на приём к врачу эндокринологу в Уфе можно по адресу проспект Октября, 62/2, в хозрасчетной поликлинике на Юношеской библиотеке, где лучшие специалисты поставят диагноз и проведут лечение любых патологий эндокринной системы.
        </p>
        <h2 class="doctors__title">Симптомы, при которых стоит показаться врачу</h2>
        <p class="directions__desc directions__desc--menu">
          Расстройства эндокринной системы могут проявляться такими симптомами:
        </p>
        <ul class="list list--menu">
          <li class="list__item list__item--circle">беспричинная усталость, апатия, депрессивные настроения, безразличие к жизни или наоборот, частая смена настроений;</li>
          <li class="list__item list__item--circle">резкое похудение или беспричинный набор веса;</li>
          <li class="list__item list__item--circle">дрожь в конечностях;</li>
          <li class="list__item list__item--circle">чрезмерная потливость;</li>
          <li class="list__item list__item--circle">сильное выпадение волос или ухудшение их внешнего вида;</li>
          <li class="list__item list__item--circle">непреходящая жажда или ощущение постоянной сухости во рту;</li>
          <li class="list__item list__item--circle">беспричинная тахикардия (частое сердцебиение);</li>
          <li class="list__item list__item--circle">накатывающие приливы жара;</li>
          <li class="list__item list__item--circle">ухудшение памяти, снижение интеллектуальных способностей.</li>
        </ul>
        <p class="directions__desc directions__desc--menu">При любых перечисленных выше симптомах незамедлительно приходите на приём к эндокринологу в нашу хозрасчетную поликлинику на Юношеской библиотеке, чтобы пройти обследование и, при необходимости, начать соответствующее лечение как можно раньше.
        </p>
        <section class="reviews">
          <h2 class="doctors__title">Отзывы</h2>
          <div class="reviews__wrapper">
            <span class="reviews__patient">Александра</span>
            <blockquote class="reviews__text">
              Обратилась к эндокринологу по поводу щитовидной железы, благодарна за подробный разговор и назначенное лечение.
            </blockquote>
          </div>
          <div class="reviews__wrapper">
            <span class="reviews__patient">Нина Георгиевна</span>
            <blockquote class="reviews__text">
              Поняла, что с памятью все хуже. Стала ходить по врачам, пошла к неврологу, а оказалось надо к эндокринологу, это щитовидка “шалит”. Спасибо врачам хозрасчетной поликлиники, нашли причину, теперь буду надеяться, что лечение поможет.
            </blockquote>
          </div>
        </section>
      </div>
