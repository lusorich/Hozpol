...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Травматология. Запишитесь на приём в поликлинику по телефону 7 (347) 278-85-35">
    <title>Травматология - запись на приём в хозрасчетной поликлинике</title>
    ...
    <main class="page">
      <div class="container">
        <div class="wrapper-title wrapper-title--doctors">
          <h1 class="page__title">Травматология</h1>
        </div>
        <ul class="product__menu-list">
          ...
          <li class="product__menu-item product__menu-item--active"><a href="#">Травматология</a></li>
